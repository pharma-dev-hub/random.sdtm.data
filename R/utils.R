...
suppqs_terms <- tibble::tibble(
  QNAM = c("RESULT_ABBR", "IDEATION_WISH", "IDEATION_NONSPEC", "IDEATION_SPEC", "IDEATION_INTENT", "IDEATION_PLAN",
           "IDEATION_MOST_SEV", "INTENSITY_FREQ", "INTENSITY_DUR", "INTENSITY_CONTROL",
           "INTENSITY_DETER", "INTENSITY_REASONS", "INTENSITY_SCORE", "BEHAVE_ACTUAL", "BEHAVE_ACTUAL_NUM",
           "BEHAVE_INTERRUPT", "BEHAVE_INTERRUPT_NUM", "BEHAVE_ABORTED", "BEHAVE_ABORTED_NUM", "BEHAVE_PREP_ACT",
           "BEHAVE_PREP_ACT_NUM", "NSSIB", "NSSIB_NUM", "LETHAL_MSA", "LETHAL_MRA", "LETHAL_FA",
           "POT_LETHAL_MSA", "POT_LETHAL_MRA", "POT_LETHAL_FA", "RESULT_ABBR_RECENT"),
  QLABEL = c("Lifetime Outcome", "Wish to be Dead-Life", "Non-Specific Suicidal Thought-Life", "Specific Thoughts Method-Life",
             "Idea, Intent, No Plan-Life", "Idea, Plan, Intent-Life", "Most Severe Idea-Life", "Most Severe Idea, Frequency-Life",
             "Most Severe Idea, Duration-Life", "Most Severe Idea, Control-Life",
             "Most Severe Idea, Deterrents-Life", "Most Severe Idea, Reasons-Life", "Total Intensity Score-Life",
             "Actual Attempt-Life", "Number of Actual Attempts-Life", "Interrupted Attempt-Life", "Number of Interrupted Attempts-Life",
             "Aborted Attempt-Life", "Number of Aborted Attempts-Life", "Preparatory Acts/Behavior-Life",
             "Number of Preparatory Acts-Life", "Non-suicidal Self-injurious Behavior-Life", "Number of Non-suicidal Self-injurious Behaviors-Life",
             "Most Serious Attempt Lethality-Life", "Most Recent Attempt Lethality-Life", "First Attempt Lethality-Life",
             "Most Serious Attempt Potential-Life", "Most Recent Attempt Potential-Life", "First Attempt Potential-Life",
             "Recent Outcome"),
  QORIG = c(rep("ePRO", 30)),
  QEVAL = c(rep("INVESTIGATOR", 30))
)
